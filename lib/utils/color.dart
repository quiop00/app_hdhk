...
class AppColors {
  ...
  static const Color blue = Color.fromRGBO(0, 78, 255, 1);
  static const Color brown = Color(0xFFB1736C);
  static const Color darkBrown = Color(0xD0795548);
  static const Color red2 = Color.fromRGBO(127, 38, 46, 1);
  ...
  static const Color orange = Color.fromRGBO(204, 87, 5, 1);
  static const Color purple2 = Color.fromARGB(255, 113, 51, 177);
  static const Color white2 = Color.fromRGBO(239, 239, 239, 1);
}
