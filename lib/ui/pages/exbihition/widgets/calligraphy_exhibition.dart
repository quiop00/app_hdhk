...
class CalligraphyExhibition extends StatefulWidget {
  @override
  _CalligraphyExhibitionState createState() => _CalligraphyExhibitionState();
}

class _CalligraphyExhibitionState extends State<CalligraphyExhibition>
  ...
  Widget build(BuildContext context) {
    ...
    return ProviderWidget<ExhibitionViewModel>(
        ...
        onModelReady: (model) async {
          await model.fetchExhibition(type: 'exh_calligraphy');
        },
