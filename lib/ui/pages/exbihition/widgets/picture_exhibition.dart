...
class PictureExhibition extends StatefulWidget {
  @override
  _PictureExhibitionState createState() => _PictureExhibitionState();
}

class _PictureExhibitionState extends State<PictureExhibition>
  ...
  Widget build(BuildContext context) {
    ...
    return ProviderWidget<ExhibitionViewModel>(
        ...
        onModelReady: (model) async {
          await model.fetchExhibition(type: 'exh_painting');
        },
